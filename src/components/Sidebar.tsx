  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-stone-900 text-white shadow-lg"
      >
      ...
      >
        ...
        <div className="h-16 flex items-center px-6 border-b border-stone-200">
          <Link to="/" className="flex items-center gap-3" onClick={() => setIsOpen(false)}>
            ...
            <span className="text-xl font-bold text-stone-900">SpendWise</span>
          </Link>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-stone-200">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium text-stone-900">Usuario</p>
              <p className="text-xs text-stone-500">usuario@email.com</p>
            </div>
          </div>
        </div>
      </aside>
